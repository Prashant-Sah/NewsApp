...
extension BaseController {
    ...
    func alert(title: String, msg: String, actions: [Constant.AlertAction], titleAttributes: [NSAttributedString.Key: Any]? = nil, messageAttribute: [NSAttributedString.Key: Any]? = nil, completion: ((_ action: Constant.AlertAction) -> Void)? = nil) {
